...
<div id="wrap">
      ...
      <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="${pageContext.request.contextPath}/book_store/images/bullet1.gif" alt="" title="" /></span>特刊</div>
        	...
        	<div class="feat_prod_box">
                ...
                <div class="prod_det_box">
                    ...
                    <a href="${pageContext.request.contextPath}/FindProductDetails.action?productId=${sessionScope.specials_product1.productId}" class="more">- 更多细节 -</a>
                    <div class="clear"></div>
                    </div>
        	...
        	<div class="feat_prod_box">
                ...
                <div class="prod_det_box">
                    ...
                    <a href="${pageContext.request.contextPath}/FindProductDetails.action?productId=${sessionScope.specials_product2.productId}" class="more">- 更多细节 -</a>
                    <div class="clear"></div>
                    </div>
        	...
        	<div class="feat_prod_box">
                ...
                <div class="prod_det_box">
                    ...
                    <a href="${pageContext.request.contextPath}/FindProductDetails.action?productId=${sessionScope.specials_product3.productId}" class="more">- 更多细节 -</a>
                    <div class="clear"></div>
                    </div>
        	...
        	<div class="feat_prod_box">
                ...
                <div class="prod_det_box">
                    ...
                    <a href="${pageContext.request.contextPath}/FindProductDetails.action?productId=${sessionScope.specials_product4.productId}" class="more">- 更多细节 -</a>
                    <div class="clear"></div>
                    </div>
