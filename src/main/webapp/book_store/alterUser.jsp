...
<div id="wrap">
     ...
     <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="${pageContext.request.contextPath}/book_store/images/bullet1.gif" alt="" title="" /></span>修改账户信息</div>
            ...
            请按照条款和规定修改
                ...
                <div class="form_subtitle">信息修改</div>
                 <form name="register" action="${pageContext.request.contextPath}/AlterUserServlet.action" method="post">          
                    <div class="form_row">
                    <strong>姓名:</strong>
                    ...
                    <div class="form_row">
                    <strong>密码:</strong>
                    <input type="password" class="contact_input" name="password" value="${sessionScope.user.password}"/>
                    </div> 
                    ...
                    <%
                     ...
                     城市:<input type="text" name="city" size="5" value="${sessionScope.user.contcatinfo.city}"/>
                    </div>                    
