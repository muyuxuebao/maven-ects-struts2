...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="${pageContext.request.contextPath}/book_store/images/bullet1.gif" alt="" title="" /></span>联系</div>
        
        	<div class="feat_prod_box_details">
            <p class="details">
           请将您的问题告诉我们,我们将第一时间给您答复
            </p>
            
              	<div class="contact_form">
                <div class="form_subtitle">请输入您的详细信息</div>          
                    <div class="form_row">
                    ...
                    <div class="form_row">
                    <label class="contact"><strong>公司名:</strong></label>
                    <input type="text" class="contact_input" />
                    </div>


                    <div class="form_row">
                    <label class="contact"><strong>附言:</strong></label>
                    <textarea class="contact_textarea" ></textarea>
                    </div>

                    
                    <div class="form_row">
                    <a href="#" class="contact">提交</a>                    </div>      
                </div>  
