...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="${pageContext.request.contextPath}/book_store/images/bullet1.gif" alt="" title="" /></span>书架</div>
    ...
    <c:forEach var="product" items="${requestScope.productsList}" >
    	<div class="new_prod_box">
    	 <table><tr><td width="100" height="50" nowrap><a href="${pageContext.request.contextPath}/FindProductDetails.action?productId=${product.productId}">${product.name}</a></td></tr></table>
                        <div class="new_prod_bg">
                        <span class="new_icon"><img src="${pageContext.request.contextPath}/book_store/images/new_icon.gif" alt="" title="" /></span>
                        <a href="${pageContext.request.contextPath}/FindProductDetails.action?productId=${product.productId}"><img src="${pageContext.request.contextPath}/book_store/${product.images}" alt="" title="" class="thumb" border="0" /></a>
                        </div>           
         </div> 
 	</c:forEach>
            ...
            <table>
            	<tr>
                 ...
                 <td>共:${requestScope.pageCount}页</td>
           		 <td><a href="${pageContext.request.contextPath}/FildAllProductServlet.action?nowCount=${requestScope.nowCount-1}">上一页</a></td>
                 <td><a href="${pageContext.request.contextPath}/FildAllProductServlet.action?nowCount=${requestScope.nowCount+1}">下一页</a></td>
