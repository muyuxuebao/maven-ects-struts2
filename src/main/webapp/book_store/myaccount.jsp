				...
				<div class="center_content">
					<div class="left_content">
						...
						<div class="feat_prod_box_details">
							<p class="details">
								如果没有账号,请先注册.谢谢您的支持,我们将竭诚为您服务.
							</p>
							<c:if test="${!(empty sessionScope.user)}" var="result">
								...
								<div class="form_row">
									...
									${sessionScope.user.contcatinfo.country.name}
								</div>
								<div class="form_row">
									<label class="contact">
										<strong>省份:</strong>
									</label>
									${sessionScope.user.contcatinfo.province.name}
								</div>
								<div class="form_row">
									<label class="contact">
										<strong>城市:</strong>
									</label>
									${sessionScope.user.contcatinfo.city}
								</div>
								<div class="form_row">
									<table>
										<tr>
											...
											<td>
												<a href="alterUser.jsp" class="checkout"> 修改</a>
											</td>
										</tr>
									</table>
								</div>
							...
							<c:if test="${(empty sessionScope.user)}" var="result">
							 <h2 align="center"><font color="red">您没有登录,请先登录.</font></h2>
							</c:if>
