       ...
       <div class="header">
        ...
        <div class="center_content">
       	<div class="left_content">
        	<div class="crumb_nav">
            <a href="index.jsp">主页</a> &gt;&gt; 产品展示
</div>
            <div class="title"><span class="title_icon"><img src="${pageContext.request.contextPath}/book_store/images/bullet1.gif" alt="" title="" /></span>产品名称:&nbsp;《${product.name}》</div>
        	...
        	<div class="feat_prod_box_details">
                ...
                <div class="prod_det_box">
                    ...
                    <div class="price"><strong>价格:</strong> <span class="red">${product.basePrice} $</span></div>
...
　　 									</c:forEach>
            ...
            <div id="demo" class="demolayout">
                ...
                <li><a class="" href="#tab2">相关联书籍</a></li>
                </ul>
    
            <div class="tabs-container">
            
                    <div style="display: block;" class="tab" id="tab1">
                                        <p class="more_details">需要了解更多的详情，读者们可以通过以下的方式查到图书的信息，或者将信息反馈给我们：</p>
                            <ul class="list">
                            <li><a href="#">在线查询：www.broadview.com.cn/06646</a></li>
                            <li><a href="#">电子邮件：jsj@phei.com.cn Or editor@broadview.com.cn</a></li>
                            <li><a href="#">我们的联系电话：010-88254369</a></li>                                          
                            </ul>
                                         <p class="more_details"> 从本书获得的各项大奖以及来自世界各地的读者评论中，不难看出这是一本经典之作。本书的作者拥有多年教学经验，对C、<a target="_blank" href="http://baike.baidu.com/view/824.htm">C++</a>以及Java语言都有独到、深入的见解，以通俗易懂及小而直接的示例解释了一个个晦涩抽象的概念。 </p>                           
                    </div>	
