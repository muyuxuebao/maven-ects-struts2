...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="${pageContext.request.contextPath}/book_store/images/bullet1.gif" alt="" title="" /></span>我的购物车</div>
            ...
            <table class="cart_table">
            	<tr class="cart_title">
                 ...
                 <c:forEach var="map" items="${sessionScope.cart.productsMap}" >
		                 <tr>
		                	<td><a href="${pageContext.request.contextPath}/FindProductDetails.action?productId=${map.key.productId}"><img src="${pageContext.request.contextPath}/book_store/${map.key.images}" alt="" title="" border="0" width="40" /></a></td>
		                	<td>${map.key.name }</td>
		                    <td>${map.key.basePrice }$</td>
		                    <td>${map.value }</td>
		                    <td>${map.key.basePrice*map.value }$</td> 
		                    <td></td>
		                    <td><a href="${pageContext.request.contextPath}/DeleteCartItems.action?itemKeyId=${map.key.productId}">删除</a></td>              
		                </tr>          
 	  		  	</c:forEach>
            ...
            <table width="100%" align="center" >
            	<tr>
                    ...
                    <td align="left"> <a href="${pageContext.request.contextPath}/DeleteCartItems.action?deleteAll=1" class="checkout"> 清空</a></td>
                    <td align="center"><a href="${pageContext.request.contextPath}/FildAllProductServlet.action?nowCount=1" class="continue"> 继续购物</a></td>
                    <td align="right"> <a href="${pageContext.request.contextPath}/book_store/filInOrder.jsp" class="checkout">加入订单</a></td>
                 </tr>
             </table>
